...
namespace AppSample.Effects
{
	public static class LineColorEffect
	{
		...
		{
			public EntryLineColorEffect() : base("AppSample.EntryLineColorEffect")
			{
			}
		}
		...
		{
			public DatePickerLineColorEffect() : base("AppSample.DatePickerLineColorEffect")
			{
			}
		}
		...
		{
			public PickerLineColorEffect() : base("AppSample.PickerLineColorEffect")
			{
			}
		}
	}
